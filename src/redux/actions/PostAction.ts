...
import { approvePostAPI, createPostAPI, deletePostAPI, editPostAPI, getAllPostAPI, getMostVotedPostAPI, getOnePostAPI, searchPostAPI, searchPostByTagAPI } from "../api/PostAPI";
